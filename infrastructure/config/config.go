...
import (
	...
	"github.com/kasv2/kasv2d/util/network"
	"github.com/kasv2/kasv2d/version"
	"github.com/pkg/errors"
)

const (
	defaultConfigFilename      = "kaspadV2.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "kaspadV2.log"
	defaultErrLogFilename      = "kaspadV2_err.log"
	...
	sampleConfigFilename    = "sample-kaspadV2.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for kaspadV2.
...
// Flags defines the configuration options for kaspadV2.
//
...
// Config defines the configuration options for kaspadV2.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default kaspadV2 configuration
...
//
// The above results in kaspadV2 functioning properly without any config settings
...
// createDefaultConfig copies the file sample-kaspadV2.conf to the given destination path,
